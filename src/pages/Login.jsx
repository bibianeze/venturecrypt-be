...
const handleSubmit = async (e) => {
  ...
  try {
    const response = await axios.post('https://venturecrypt-be-backend.onrender.com/api/auth/login', formData);
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0B0F1A] via-[#0F2A44] to-[#0B0F1A] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300">Secure your financial future</p>
        </div>

        {/* Login Card */}
        <div className="bg-white/10 backdrop-blur-lg rounded-3xl shadow-2xl p-8 border border-white/20">
          <h2 className="text-3xl font-bold text-white mb-2">Welcome Back</h2>
          <p className="text-gray-300 mb-6">Login to access your account</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-crypto-accent focus:border-transparent transition"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  required
                  className="w-full px-4 py-3 pr-12 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-crypto-accent focus:border-transparent transition"
                  placeholder="••••••••"
                />
                <button
                  type="button"
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-300">
              ...
              <Link to="/signup" className="text-crypto-gold hover:text-crypto-accent font-semibold transition">
                Sign Up
              </Link>
            </p>
          </div>
